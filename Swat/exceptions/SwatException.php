 ...
 * may contain sensitive data. For example, credit card numbers should not be
 ...
 * documentation will be filtered out of stack traces. IMPORTANT: Each tag can
...
class SwatException extends Exception
{
    ...
    protected static SwatExceptionDisplayer $displayer;

    /**
     * @var array<SwatExceptionLogger>
     */
    protected static array $loggers = [];

    /**
     * Whether or not this exception was manually handled.
     */
     ...
     */
    public static function setLogger(SwatExceptionLogger $logger): void
    {
        self::$loggers = [$logger];
    }
     ...
     *                                    exception loggers
     */
    public static function addLogger(SwatExceptionLogger $logger): void
    {
        self::$loggers[] = $logger;
    }
     ...
     *                                          exceptions
     */
    public static function setDisplayer(SwatExceptionDisplayer $displayer): void
    {
