...
class DemoApplication
{
    ...
    private function buildDemo()
    {
        ...
        if (
            file_exists(
                __DIR__ . '/../include/demos/' . $this->demo . 'Demo.php',
            )
        ) {
    ...
    private function buildXmlSourceView()
    {
        ...
        if (file_exists($filename)) {
            ...
            $this->layout_ui->getWidget(
                'xml_source_view',
            )->content = $pre_tag->toString();
        }
    }
    ...
    private function buildDemoDocumentationMenuBar()
    {
        switch ($this->demo) {
            case 'Accordion':
                $entries = ['SwatAccordion', 'SwatNoteBookPage'];
                break;

            case 'Button':
                $entries = ['SwatButton', 'SwatConfirmationButton'];
                break;
            ...
            case 'Disclosure':
                $entries = ['SwatDisclosure', 'SwatFrameDisclosure'];
                break;
            ...
            case 'ImageDisplay':
                $entries = ['SwatImageDisplay', 'SwatImagePreviewDisplay'];
                break;
            ...
            case 'NavBar':
                $entries = ['SwatNavBar', 'SwatNavBarEntry'];
                break;

            case 'NoteBook':
                $entries = ['SwatNoteBook', 'SwatNoteBookPage'];
                break;
            ...
            case 'PasswordEntry':
                $entries = ['SwatPasswordEntry', 'SwatConfirmPasswordEntry'];
                break;
            ...
            case 'RadioList':
                $entries = ['SwatRadioList', 'SwatRadioTable'];
                break;
            ...
            case 'Textarea':
                $entries = ['SwatTextarea', 'SwatXHTMLTextarea'];
                break;
        ...
        $documentation_links = $this->layout_ui->getWidget(
            'documentation_links',
        );
