...
class FlydownDemo extends Demo
{
    public function buildDemoUI(SwatUI $ui)
    {
        ...
        $flydown->addOption(new SwatOption('mackintosh', 'McIntosh'), [
            'classes' => 'apple',
        ]);

        $flydown->addOption(new SwatOption('courtland', 'Courtland'), [
            'classes' => 'apple',
        ]);

        $flydown->addOption(new SwatOption('golden', 'Golden Delicious'), [
            'classes' => 'apple',
        ]);

        $flydown->addOption(new SwatOption('fuji', 'Fuji'), [
            'classes' => 'apple',
        ]);

        $flydown->addOption(new SwatOption('smith', 'Granny Smith'), [
            'classes' => 'apple',
        ]);

        $flydown->addOption(new SwatOption('navel', 'Navel'), [
            'classes' => 'orange',
        ]);

        $flydown->addOption(new SwatOption('blood', 'Blood'), [
            'classes' => 'orange',
        ]);

        $flydown->addOption(new SwatOption('florida', 'Florida'), [
            'classes' => 'orange',
        ]);

        $flydown->addOption(new SwatOption('california', 'California'), [
            'classes' => 'orange',
        ]);

        $flydown->addOption(new SwatOption('mandarin', 'Mandarin'), [
            'classes' => 'orange',
        ]);
        ...
        $apples->addChild(
            new SwatTreeFlydownNode('golden', 'Golden Delicious'),
        );
